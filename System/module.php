...
class System extends InstarBaseModule
{
    ...
    public static $Variables = [
        ...
        'UserAdminTokenExpire'                             => ['User Admin Token Expire', VARIABLETYPE_INTEGER, 'INSTAR.SystemUserAdminTokenExpire', true, true, 'user/admin/token/expire'],
        ...
        'WebUITheme'                                       => ['WebUI Theme', VARIABLETYPE_INTEGER, 'INSTAR.SystemWebUITheme', true, true, 'webui/theme'],
