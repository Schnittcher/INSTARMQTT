...
class Network extends InstarBaseModule
{
    const SUBTOPIC = 'network';

    public static $Variables = [
        'ConfigDHCP'                                           => ['DHCP', VARIABLETYPE_BOOLEAN, '~Switch', true, true, 'config/dhcp'],
        'ConfigIPAddr'                                         => ['IP-Address', VARIABLETYPE_STRING, '', true, true, 'config/ipaddr'],
        'ConfigNetmask'                                        => ['Netmask', VARIABLETYPE_STRING, '', true, true, 'config/netmask'],
        'ConfigGateway'                                        => ['Gateway', VARIABLETYPE_STRING, '', true, true, 'config/gateway'],
        ...
        'ConfigNetworktype'                                    => ['Network Type', VARIABLETYPE_STRING, '', false, true, 'config/networktype'],
        'ConfigMacAddress'                                     => ['MAC Address', VARIABLETYPE_STRING, '', false, true, 'config/macaddress'],
        'ConfigHTTPPort'                                       => ['HTTP Port', VARIABLETYPE_INTEGER, '', true, true, 'config/httpport'],
        'ConfigHTTPSPort'                                      => ['HTTPS Port', VARIABLETYPE_INTEGER, '', true, true, 'config/httpsport'],
        'ConfigRTSPPort'                                       => ['RTSP Port', VARIABLETYPE_INTEGER, '', true, true, 'config/rtspport'],
