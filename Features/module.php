...
class Features extends InstarBaseModule
{
    ...
    public static $Variables = [
        ...
        'NightvisionThresholdHigh'                                                    => ['Nightvision Threshold High', VARIABLETYPE_INTEGER, 'INSTAR.NightvisionThreshold', true, true, 'nightvision/threshold/high'],
        'NightvisionThresholdLow'                                                     => ['Nightvision Threshold Low', VARIABLETYPE_INTEGER, 'INSTAR.NightvisionThreshold', true, true, 'nightvision/threshold/low'],
        ...
        'NightvisionCurrentBrightness'                                                => ['Nightvision Current Brightness', VARIABLETYPE_INTEGER, 'INSTAR.NightvisionCurrentBrightness', true, true, 'nightvision/currentbrightness'],
        ...
        'PTZParkPresetInterval'                                                       => ['PTZ Park Preset Interval', VARIABLETYPE_INTEGER, 'INSTAR.PTZParkPresetInterval', true, true, 'ptz/parkpreset/interval'],
        ...
        'SDRstorageDuration'                                                          => ['SD Rstorage Duration', VARIABLETYPE_INTEGER, 'INSTAR.SDRstorageDuration', true, true, 'sd/rstorage/duration'],
